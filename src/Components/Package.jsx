...
//     return (
//         <div className="flex flex-col items-center justify-center bg-white p-14">
//             <div className="text-center mb-8">
//                 <h1  className="text-3xl md:text-4xl lg:text-5xl font-semibold text-[#1167b1]">Get Your Digital Card Package Now</h1>
//                 <p className="text-gray-700 mt-2">
//                    <span> Select a plan that best suits your needs and create</span> <br /> 
//                    professional digital cards effortlessly.
//                 </p>
//             </div>
...
//                     <h3 className="text-[#1167b1] mb-2 font-bold">
//                         Basic plan</h3>
