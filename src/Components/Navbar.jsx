...
//           <button className="text-[#1167b1] font-semibold border border-[#1167b1] px-6 py-2 rounded-lg hover:bg-blue-50">
//             Login
//           </button>
//           <button className="bg-[#1167b1] text-white px-6 py-2 rounded-lg hover:bg-[#0f5b9d]">
//             Sign Up
//           </button>
//         </div>
//       </div>
