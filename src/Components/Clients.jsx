...
// const Clients = () => {
//   return (
//     <div className="flex flex-col items-center justify-center bg-white p-8 mt-20"> {/* Adjusted padding for better spacing */}
//       {/* Title Section */}
...
//             <span>Join our plan and connect</span> <br />
...
//             {/* Updated Bar Graph Section */}
//             <div className="mt-2 flex space-x-2 justify-center">
//               <div className="flex flex-col items-center">
//                 <div className="h-4 w-2  bg-blue-200 rounded-lg"></div>
//               </div>
//               <div className="flex flex-col items-center">
//                 <div className="h-6 w-2 bg-blue-300 rounded-lg"></div>
//               </div>
//               <div className="flex flex-col items-center">
//                 <div className="h-10 w-2 bg-blue-400 rounded-lg"></div>
//               </div>
//               <div className="flex flex-col items-center">
//                 <div className="h-14 w-2 bg-blue-500 rounded-lg"></div>
//               </div>
//             </div>
//           </div>
//         </div>
