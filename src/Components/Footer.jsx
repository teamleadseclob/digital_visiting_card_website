  ...
  return (
    <footer className="flex flex-col items-center justify-center bg-[#006391] text-white p-8">
      ...
      <div className="flex justify-end mt-8 w-full">
        <div className="flex items-center space-x-2 bg-white p-1.5 rounded-full w-full max-w-sm">
          <input
            type="text"
            placeholder="Reach out to us"
            className="flex-grow p-1 rounded-full bg-white text-gray-800 text-sm focus:outline-none"
          />
          <button className="bg-[#006391] text-white rounded-full px-3 py-1 text-sm font-medium">
            Send
          </button>
        </div>
      </div>
